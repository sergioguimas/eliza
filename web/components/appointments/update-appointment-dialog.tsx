...
export function UpdateAppointmentDialog({
  ...
  async function performSubmit() {
    ...
    if (result?.error) {
      ...
      toast.success(messages.appointment_updated || "Atualizado com sucesso!")
      onOpenChange(false)
    }
    ...
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            <DialogTitle>
              {actions.edit || "Editar"} {agendamento}
            </DialogTitle>
      ...
      <AlertDialog open={showOutsideHoursAlert} onOpenChange={setShowOutsideHoursAlert}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {messages.outside_hours_description ||
                "O horário selecionado parece fora do expediente. Deseja continuar mesmo assim?"}
            </AlertDialogDescription>
          </AlertDialogHeader>
